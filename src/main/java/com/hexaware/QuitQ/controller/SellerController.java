...
public class SellerController {
	...
	public ResponseEntity<Seller> updateSellerMobileHandler(@RequestBody SellerDTO sellerdto, @RequestHeader("token") String token){
	...
	public ResponseEntity<SessionDTO> updateSellerPasswordHandler(@RequestBody SellerDTO sellerDto, @RequestHeader("token") String token){
